...
The Repository for SWCCDC teams to submit team-made docs, scripts, and configuration files they wish to bring into the game environment. You must submit a pull request against this repo by **Sunday, February 27th, at 11:59pm central time** for consideration. The Southwest CCDC team will review and merge acceptable submissions. Your PR/submission should contain all the materials you want to include in your school's folder, NOT ENCRYPTED OR OBFUSCATED in any way. Everything posted to this repo must be available for any team to use and open to scrutiny by the competition organizers AND other teams. You may only submit things your team has created or modified for use during the game that you have the rights to distribute. Only items approved and merged into the main branch of this repository may be used in the game.
...
While logged in to GitHub (you do need to have an account), click the "Fork" button on [https://github.com/SouthwestCCDC/2022-Regionals-Shared/](https://github.com/SouthwestCCDC/2022-Regionals-Shared/).
